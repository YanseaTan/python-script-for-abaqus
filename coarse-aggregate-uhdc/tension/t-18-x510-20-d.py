...
while True:
    ...
    if len(center10)==0:
        ...
        if interCheck([disX,disY,disZ],center10,5,5):
            center10.append([disX,disY,disZ])
            count10 += 1
    if count10 >= 50*50*100*dopingRate*2/3/4*3/math.pi/radius/radius/radius:
        break
...
while True:
    ...
    if interCheck([disX,disY,disZ],center8,4,4):
        if interCheck([disX,disY,disZ],center10,4,5):
            ...
            count8 += 1
    if count8 >= 50*50*100*dopingRate/4/4*3/math.pi/radius/radius/radius:
        break
    ...
    if interCheck([disX,disY,disZ],center5,2.5,2.5):
        if interCheck([disX,disY,disZ],center8,2.5,4):
            if interCheck([disX,disY,disZ],center10,2.5,5):
                ...
                count5 += 1
    if count5 >= 50*50*100*dopingRate/12/4*3/math.pi/radius/radius/radius:
        break
...
# job
mdb.Job(name='x20t', model='Model-1', description='', type=ANALYSIS, 
