...
while True:
    ...
    if len(center15)==0:
        ...
        if interCheck([disX,disY,disZ],center15,7.5,7.5):
            center15.append([disX,disY,disZ])
            count15 += 1
    if count15 >= 50*50*100*dopingRate*2/3/4*3/math.pi/radius/radius/radius:
        break
...
while True:
    ...
    if interCheck([disX,disY,disZ],center12,6,6):
        if interCheck([disX,disY,disZ],center15,6,7.5):
            ...
            count12 += 1
    if count12 >= 50*50*100*dopingRate/4/4*3/math.pi/radius/radius/radius:
        break
    ...
    if interCheck([disX,disY,disZ],center8,4,4):
        if interCheck([disX,disY,disZ],center12,4,6):
            if interCheck([disX,disY,disZ],center15,4,7.5):
                ...
                count8 += 1
    if count8 >= 50*50*100*dopingRate/12/4*3/math.pi/radius/radius/radius:
        break
...
# job
mdb.Job(name='t20t', model='Model-1', description='', type=ANALYSIS, 
