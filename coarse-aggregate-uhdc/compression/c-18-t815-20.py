...
while True:
    ...
    if len(center15)==0:
        ...
        if interCheck([disX,disY,disZ],center15,7.5,7.5):
            center15.append([disX,disY,disZ])
            count15 += 1
    if count15 >= 100*100*100*dopingRate/3/4*3/math.pi/radius/radius/radius:
        break

# caculate diameter of 12mm
count12 = 0
center12 = []
radius = 6
while True:
    ...
    if interCheck([disX,disY,disZ],center12,6,6):
        if interCheck([disX,disY,disZ],center15,6,7.5):
            ...
            count12 += 1
    if count12 >= 100*100*100*dopingRate/3/4*3/math.pi/radius/radius/radius:
        break

# caculate diameter of 8mm
count8 = 0
center8 = []
radius = 4
while True:
    ...
    if interCheck([disX,disY,disZ],center8,4,4):
        if interCheck([disX,disY,disZ],center12,4,6):
            if interCheck([disX,disY,disZ],center15,4,7.5):
                ...
                count8 += 1
    if count8 >= 100*100*100*dopingRate/3/4*3/math.pi/radius/radius/radius:
        break
...
mdb.models['Model-1'].materials['ceramsite'].Elastic(table=((30000.0, 0.2), ))
...
count = count15 + count12 + count8
refPoints1=(r1[count * 2 + 5], )
